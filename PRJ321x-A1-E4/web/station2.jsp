<%-- 
    Document   : station2
    Created on : Sep 22, 2019, 10:43:05 AM
    Author     : AMIN
--%>
...
<% 
    String title = "Station 2";
    String subTitle = "2017-2018";
    String colorCode = "#282a5d";
%>
<%@include file="/components/header.jsp" %>
<%@include file="/entity/station2songs.jsp" %>
<section class="p-3">
    <h3>Tracklist</h3>
    <hr class="m-0" />
    <% for (Song s : station2Songs) { %>
