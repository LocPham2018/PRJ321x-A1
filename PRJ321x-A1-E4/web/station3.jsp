<%-- 
    Document   : station3
    Created on : Sep 22, 2019, 11:22:34 AM
    Author     : AMIN
--%>
...
<% 
    String title = "Station 3";
    String subTitle = "2018-2019";
    String colorCode = "#bc3a52";
%>
<%@include file="/components/header.jsp" %>
<%@include file="/entity/station3songs.jsp" %>
<section class="p-3">
    <h3>Tracklist</h3>
    <hr class="m-0" />
    <% for (Song s : station3Songs) { %>
